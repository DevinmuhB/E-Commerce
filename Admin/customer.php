...
<table cellpadding="10" cellspacing="0" style="width: 100%; border-collapse: collapse;">
    ...
    <tbody>
                    ...
                    <?php if ($row['status'] === 'Diproses Admin'): ?>
                        <div style="font-size: 12px;">
                            ...
                            <?php if ($row['bukti_pembayaran']): ?>
                                <a href="../<?= htmlspecialchars($row['bukti_pembayaran']) ?>" target="_blank" style="color: #007bff; text-decoration: none;">
        ...
        <?php endwhile; else: ?>
            <tr><td colspan="9" style="text-align:center;"><em>Tidak ada pesanan</em></td></tr>
        <?php endif; ?>
    </tbody>
</table>
</div>
